...
![shushengstage](../../images/shushengstage.png)  

![shushengstage2](../../images/shushengstage2.png)  

![shushengstage3](../../images/shushengstage3.png)  

![shushengstage4](../../images/shushengstage4.png)  
...
这里仍然选择之前练习RAG操作的开发机进行测试，新建对应的conda虚拟环境。  
...
然后打开opencompass文件下configs/models/hf_internlm/的`hf_internlm2_chat_1_8b.py`，贴入下面代码  
...
![openpassscore](../../images/openpassscore.png)  
